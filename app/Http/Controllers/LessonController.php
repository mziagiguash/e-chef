...
class LessonController extends Controller
{
    public function index()
    {
        ...
        foreach ($lessons as $lesson) {
            ...
            $lesson->display_course = $lesson->course ? $lesson->course->localized_title : 'No Course';
        }
    ...
    {
        $locale = app()->getLocale();
        $courses = Course::all()->map(function ($course) use ($locale) {
            $course->display_title = $course->getTranslation('title', $locale);
            return $course;
        });
