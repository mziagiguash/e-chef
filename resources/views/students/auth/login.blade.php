        ...
        <div class="row align-items-center">
            <div class="col-xl-5 order-2 order-xl-0">
                <div class="signup-area-textwrapper">
                    <h2 class="font-title--md mb-0">@lang('auth.sign_in')</h2>
                    <p class="mt-2 mb-lg-4 mb-3">
                        @lang('auth.no_account')
                        <a href="{{ route('studentRegister', ['locale' => app()->getLocale()])}}" class="text-black-50">
                            @lang('auth.sign_up')
                        </a>
                    </p>
                    <form action="{{ route('studentLogin.check', ['locale' => app()->getLocale(), 'back_route' => 'studentdashboard']) }}" method="POST">
@csrf
                        <div class="form-element">
                            <label for="email">@lang('auth.email')</label>
                            <input type="email" placeholder="@lang('auth.enter_email')" id="email" name="email" />
                            @error('email')
                        ...
                        <div class="form-element">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="#" class="text-primary fs-6">@lang('auth.forgot_password')</a>
                            </div>
                            <div class="form-alert-input">
                                <input type="password" placeholder="@lang('auth.enter_password')" id="password" name="password" />
                        ...
                        <div class="form-element d-flex align-items-center terms">
                            ...
                            <label for="agree" class="text-secondary mb-0 fs-6">@lang('auth.remember_me')</label>
                        </div>
                        <div class="form-element">
