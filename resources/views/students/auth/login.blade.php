        ...
        <div class="row align-items-center">
            <div class="col-xl-5 order-2 order-xl-0">
                <div class="signup-area-textwrapper">
                    ...
                    <p class="mt-2 mb-lg-4 mb-3">Don't have account? <a href="{{localeRoute('studentRegister')}}"
                            class="text-black-50">Sign
                            up</a></p>
                    <form action="{{ localeRoute('studentLogin.check', ['back_route' => 'studentdashboard']) }}" method="POST">
                      @csrf
