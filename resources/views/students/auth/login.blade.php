            ...
            <div class="col-xl-5 order-2 order-xl-0">
                <div class="signup-area-textwrapper">
                    ...
                    <p class="mt-2 mb-lg-4 mb-3">
                        ...
                        <a href="{{ route('studentRegister', ['locale' => app()->getLocale()]) }}" class="text-black-50">Sign up</a>
                    </p>

                    <form action="{{ route('studentLogin.check', ['locale' => app()->getLocale()]) }}" method="POST">
                        @csrf
                        <div class="form-element">
                            <label for="email">Email</label>
                            <input type="email" placeholder="Username" id="email" name="email" value="{{ old('email') }}" required />
                            @error('email')
