        ...
        <div class="row align-items-center justify-content-md-center">
            <div class="col-lg-5 order-2 order-lg-0">
                <div class="signup-area-textwrapper">
                    ...
                    <p class="mt-2 mb-lg-4 mb-3">Already have account? <a href="{{localeRoute('studentLogin')}}" class="text-black-50">Sign In</a></p>
                    <form action="{{ localeRoute('studentRegister.store', ['back_route' => 'studentdashboard']) }}" method="POST">
                    @csrf
