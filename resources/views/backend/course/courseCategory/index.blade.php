                                        ...
                                        <tbody>
                                            @forelse ($data as $d)
                                                @php
                                                    ...
                                                    $names = is_array($decoded) ? array_merge($defaultTranslations, $decoded) : $defaultTranslations;
                                                @endphp
                                                <tr>
                                                    ...
                                                    <td>
                                                        @foreach($locales as $localeCode => $localeName)
                                                            <span class="cat-name lang-{{ $localeCode }}" style="{{ $localeCode === $appLocale ? '' : 'display:none' }}">
                                                                {{ $names[$localeCode] ?? '' }}
                                                            </span>
                                                        @endforeach
                                                    </td>
                                                    ...
                                                    <td>
                                                        <img class="rounded" width="200" height="100" src="{{ asset('public/uploads/courseCategories/' . ($d->category_image ?? '')) }}" alt="">
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('courseCategory.edit', $d->id) }}" class="btn btn-sm btn-primary" title="Edit"><i class="la la-pencil"></i></a>
                                    ...
                                    <div class="card card-profile">
                                        ...
                                        <div class="card-body pt-2">
                                            <div class="text-center">
                                                ...
                                                @foreach($locales as $localeCode => $localeName)
                                                    <h3 class="mt-4 mb-1 cat-name-grid lang-{{ $localeCode }}" style="{{ $localeCode === $appLocale ? '' : 'display:none' }}">{{ $names[$localeCode] ?? '' }}</h3>
                                                @endforeach
