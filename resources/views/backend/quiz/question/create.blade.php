        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{localeRoute('question.create')}}">Add Question</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{localeRoute('question.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
