                ...
                <div class="cart-wizard-area">
                    ...
                    <div class="text">
                        ...
                        <div class="bottom-wizard d-flex justify-content-between align-items-center">
                            <p>
                                {{ $details['price'] ? $currencySymbol . $details['price'] : 'Free' }}
                                <span><del>{{ $details['old_price'] ? $currencySymbol . $details['old_price'] : '' }}</del></span>
                            </p>
            ...
            <div class="col-lg-4">
                ...
                <div class="summery-wizard">
                    ...
                    <form action="{{ route('coupon_check') }}" method="post">
                        @csrf
                        <a href="{{ route('checkout') }}" class="button button-lg button--primary form-control mb-lg-3">Checkout</a>
